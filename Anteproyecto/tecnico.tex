...
\begin{center}
  \vspace{4cm}
  {\color{white} \Huge \textbf{Explotando el Paralelismo de Datos en el Intercomunicador intercom-TM}}
\end{center}
...
\vspace{0.95cm}
\begin{tabular}{ll}
  ~~~~~~~~~~~~~~~~~ & Paralelismo de Datos, audio, intercomunicador, procesamiento en tiempo real
\end{tabular}
